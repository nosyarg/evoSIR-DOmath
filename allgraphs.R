...
lines(theory$lambda,theory$t,col = 'red')
lines(lowerbound$lambda,1-lowerbound$z,col = 'blue')
...
lines(theory$lambda,1-theory$u,col = 'red')
dev.off()
...
lines(theory$rho,theory$t,col = 'red')
lines(lowerbound$rho,1-lowerbound$z,col = 'blue')
...
lines(theory$rho,1-theory$u,col = 'red')
dev.off()
...
lines(theory$lambda,1-theory$z,col = 'red')
dev.off()
...
lines(theory$rho,1-theory$z,col = 'red')
dev.off()
...
plot(simulationdata$t,simulationdata$r/simulationdata$n,type = 'l',col = 'blue',xlab = 'time', ylab = 'population proportion',main = 'Simulation Data',xlim = c(0,10),ylim = c(0,1))
lines(simulationdata$t,simulationdata$i/simulationdata$n, col = 'red')
lines(simulationdata$t,simulationdata$s/simulationdata$n, col = 'green')
dev.off()
#Simulation with rewiring
simulationdata <- read.csv('data/realexptimerewire.csv')
png(filename = 'plots/realtimesimgraphrewire.png')
plot(simulationdata$t,simulationdata$r/simulationdata$n,type = 'l',col = 'blue',xlab = 'time', ylab = 'population proportion',main = 'Simulation Data with Rewiring',xlim = c(0,10),ylim = c(0,1))
lines(simulationdata$t,simulationdata$i/simulationdata$n, col = 'red')
lines(simulationdata$t,simulationdata$s/simulationdata$n, col = 'green')
...
plot(theory$t,theory$R,type = 'l',xlab = 'time',col = 'blue', ylab = 'population proportion', main = 'One Edge Only Diffeq',xlim = c(0,10),ylim = c(0,1))
lines(theory$t,theory$I,col = 'red')
lines(theory$t,theory$S,col = 'green')
dev.off()
#new theory
png(filename = 'plots/realtimemanyedgetheory.png')
theory <- read.csv('theory/realtimeexptheoryimproved.csv')
plot(theory$t,theory$R,type = 'l',xlab = 'time',col = 'blue', ylab = 'population proportion', main = 'All Edges Diffeq',xlim = c(0,10),ylim = c(0,1))
lines(theory$t,theory$I,col = 'red')
lines(theory$t,theory$S,col = 'green')
dev.off()
#Miller 11 real time
...
plot(theory$t,theory$R,type = 'l',xlab = 'time',col = 'blue', ylab = 'population proportion', main = 'Miller 2011 Diffeq',xlim = c(0,10),ylim = c(0,1))
lines(theory$t,theory$I,col = 'red')
lines(theory$t,theory$S,col = 'green')
dev.off()
#ODE 3 real time
...
plot(theory$t,theory$R,type = 'l',xlab = 'time',col = 'blue', ylab = 'population proportion', main = 'ODE 3',xlim = c(0,10),ylim = c(0,1))
lines(theory$t,theory$I,col = 'red')
lines(theory$t,theory$S,col = 'green')
dev.off()
#stargraph
...
lines(lambdatheory$lambda,lambdatheory$prop,col = 'red')
dev.off()
...
lines(rhotheory$rho,rhotheory$prop,col = 'red')
dev.off()
#Real time ODE with rewiring
png(filename = 'plots/realtimeoderewire.png')
theory <- read.csv('theory/realtimeoderewire.csv')
plot(theory$t,theory$R,type = 'l',xlab = 'time',col = 'blue', ylab = 'population proportion', main = 'ODE WITH REWIRING',xlim = c(0,10),ylim = c(0,1))
lines(theory$t,theory$I,col = 'red')
lines(theory$t,theory$S,col = 'green')
